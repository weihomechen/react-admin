...
export default {
  ...
  'app.settings.security.password-description':
    '保存在数据库的密码会经过加密，登录时仍旧使用注册时所填密码即可，当前密码强度：',
  ...
  'app.settings.security.old-password': '请输入旧密码!',
  'app.settings.security.new-password': '请输入新密码!',
  'app.settings.security.confirm-password': '请确认两次输入的新密码一致!',
